...
import type { TabId, AuthUserLike } from '../types' // TabId deve ser atualizado em src/types.ts
...
// Lista de abas ATUALIZADA para incluir Dívidas, Poupança e Resumo
...
    { id: 'savings',      label: '💰 Poupanças' },
    { id: 'summary',      label: '📈 Resumo/KPIs' }, // Substitui 'analytics'
    // Note: 'analytics' foi removida
  ]
